    ...
    <div class="w-full">
        ...
        <div class="relative">
            <input
                ...
                :disabled="isDisabled"
                class="text-dark placeholder-board w-full rounded-[10px] border-1 border-[#77aace] px-4 py-3 pr-10 text-sm group-[.is-error]:border-red-400 sm:rounded-[15px] sm:py-4 sm:pl-5"
            />
